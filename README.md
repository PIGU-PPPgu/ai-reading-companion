...
| Capability | 功能 | 亮点 |
|-----------|------|------|
| 🎓 **Content Analyzer** | 内容自动识别+拆解 | 6种内容类型（文学/数学/英语/科学/社科/自定义），自动标注中考考点 |
| 📈 **Learning Guide** | 个性化学习计划 | 知识图谱拓扑排序排课，布鲁姆分类法，艾宾浩斯复习曲线 |
| 💡 **Socratic Dialog** | 苏格拉底式引导对话 | 3种模式（概念引导/解题引导/纠错引导），绝不说答案 |
| 🕸️ **Knowledge Graph** | 交互式知识图谱 | D3.js 力导向图，4层结构（学科→章节→知识点→考点），掌握度追踪 |
| 🎯 **Assessment** | 自适应测评 | 选择/填空/简答/计算四题型，掌握度实时更新 |
| 📋 **Parent Report** | 家长周报 | 学习进度+掌握度+辅导建议 |
| 🔊 **Audio Companion** | NotebookLM式播客 | 双人对话脚本+硅基流动TTS，后台任务生成 |
| 📚 **Flashcard** | 间隔重复闪卡 | 艾宾浩斯算法 |
| 🗺️ **Mindmap** | 思维导图 | Mermaid 渲染 |
| 📖 **Content Manager** | 内容导入管理 | PDF/EPUB/URL 多格式 |
