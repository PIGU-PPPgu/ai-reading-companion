...
- **Knowledge Graph UX 增强（2026-04-20）**: 图谱页新增掌握度筛选、薄弱节点快速定位、图/树/详情联动、高亮节点自动居中、树搜索高亮与默认展开
...
> 若全量 TypeScript 检查失败，先看 `web/app/(workspace)/co-writer/page.tsx` 中遗留的 `MAX_PANEL_RATIO` / `MIN_PANEL_RATIO` 问题；它与当前知识图谱页面改动无关。
...
| Phase 3 | 内容导入+前端优化 | 🚧 持续推进中：content_manager完成；知识图谱前端已完成第一轮 UX 增强 |
| Phase 4 | 打磨+测试 | ⏳ 进行中 |
| Phase 5 | 上线准备 | 📋 待开始 |
...
- 知识图谱页面新增：掌握度筛选、薄弱节点快速定位、图/树/详情联动、自动聚焦高亮节点、树搜索高亮与默认展开
